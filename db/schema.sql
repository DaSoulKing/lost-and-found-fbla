-- og table making sql, originally I actually made it one by one, creating each individual table in pgadmin4, afterwards I
-- wrote this query to create everything for the move to a railway database so we can host it plus so I can show the code
